...
import org.sonatype.nexus.plugins.labrat.internal.security.LabratSecurityFacet
...
/**
 * Support for Labrat recipes.
 */
abstract class LabratRecipeSupport
    extends RecipeSupport
{
  @Inject
  Provider<LabratSecurityFacet> securityFacet
  ...
  protected LabratRecipeSupport(final Type type, final Format format) {
    super(type, format)
  }

  // @todo Add/change matcher methods here

  static Matcher packageLabratMatcher() {
    buildTokenMatcherForPatternAndAssetKind("/{myTokenName:.+}/${PACKAGE_FILENAME}", AssetKind.PACKAGES, GET, HEAD)
  }

  static Matcher assetLabratMatcher() {
