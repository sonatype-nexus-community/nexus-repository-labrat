 ...
 */
package org.sonatype.nexus.plugins.labrat.internal.util;
...
public class LabratPathUtilsTest
    extends TestSupport
{
  private LabratPathUtils underTest;
  ...
  public void buildAssetPath() {
    String result = underTest.buildAssetPath(state, LabratPathUtils.PACKAGE_FILENAME);
